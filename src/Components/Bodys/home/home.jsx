  ...
  return (
    <main className="home-page">
      <section className="hero-section">
        <img className="background-image" src={fundoHome} alt="Cenário" />
      ...
      <section className="content-section" ref={contentRef}>
        ...
        <div className="main-content-wrapper">
          <div className="intro-block">
            ...
            <img className="intro-image" src={imgInicial} alt="Ilustração da Cidade" />
          </div>
        ...
        <p className="welcome-message">Bem vindo à <span className="city-name">"Cidade de Zeus"</span>!</p>
      </section>
    </main>
  );
}